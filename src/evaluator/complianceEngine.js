...
/**
 * Evaluates a product label against retrieved regulatory context.
 * @param {string} labelText - The extracted/structured label text.
 * @param {string[]} [categories] - Categories to filter retrieval. Null = search all.
 */
export async function evaluateCompliance(labelText, categories = null) {
  const queryParts = [
  ...
  console.log(`[compliance] Retrieving regulatory context (categories: ${catLabel})...`);
  ...
  console.log("[compliance] Sending to LLM for evaluation...");
